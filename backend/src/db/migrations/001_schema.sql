-- Aj gym — schema, indexes, materialized view (PostgreSQL 15)
...
CREATE INDEX idx_checkins_recent ON checkins (checked_in DESC);
...
CREATE INDEX idx_payments_date ON payments (paid_at DESC) INCLUDE (gym_id, amount);
